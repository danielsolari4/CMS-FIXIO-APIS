...
using Rino.BackendApi.CustomTokenProviders;
using Rino.BackendApi.Services;
using Rino.Common.Authentication;
using Rino.Dtos.Configuration;
using Rino.Managers.Implementation;
using Rino.Model.NewContext;
using Rino.Model.NewContext.Entities;
using Rino.Repositories.Implementation;
using Rino.Utils.Logging;
using Rino.Utils.Mail;

namespace Rino.BackendApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Rino.BackendApi", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Rino.BackendApi v1"));
            }
