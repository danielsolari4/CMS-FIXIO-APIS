            ...
            if (includeMedia)
            {
                foreach (var assetMedia in page.AssetMedia)
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(assetMedia.Media.SizesPaths))
                    {
                        ...
                        if (sizesPaths != null)
                        {
                            assetMediaDto.Media.Size1Path = sizesPaths.Size1Path;
                            assetMediaDto.Media.Size2Path = sizesPaths.Size2Path;
                            assetMediaDto.Media.Size3Path = sizesPaths.Size3Path;
                            assetMediaDto.Media.Size4Path = sizesPaths.Size4Path;
                            assetMediaDto.Media.Size5Path = sizesPaths.Size5Path;
                        }
                    }
                    ...
                    if (includeMedia)
                    {
                        foreach (var media in gallery.Gallery.MediaGalleries)
                        {
                            ...
                            if (!string.IsNullOrWhiteSpace(media.Media.SizesPaths))
                            {
                                ...
                                if (sizesPaths != null)
                                {
                                    mediaDto.Size1Path = sizesPaths.Size1Path;
                                    mediaDto.Size2Path = sizesPaths.Size2Path;
                                    mediaDto.Size3Path = sizesPaths.Size3Path;
                                    mediaDto.Size4Path = sizesPaths.Size4Path;
                                    mediaDto.Size5Path = sizesPaths.Size5Path;
                                }
                            }
