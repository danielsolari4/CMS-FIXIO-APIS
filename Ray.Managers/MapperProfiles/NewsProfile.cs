    ...
    internal class NewsProfile : Profile
    {
        public NewsProfile()
        {
            ...
            var m1 = CreateMap<NewsDto, News>();
                ...
                .ForMember(x => x.IsPrivate, opt => opt.MapFrom(src => src.IsPrivate)).PreserveLegacyUpdateBehavior("ViewsCount", "WasPublished", "PublicationUser", "PublicationDate", "VotesCount", "CommentsCount", "Url", "ShortUrl", "DataExtension", "IsEnabled", "ExpirationDate", "EditorComments", "NewsSourceNewsId", "IsPrivate");
            ...
            var m2 = CreateMap<PageContentDto, PageContent>();
                ...
                .ForMember(x => x.MobileTitle, opt => opt.MapFrom(src => src.MobileTitle)).PreserveLegacyUpdateBehavior("Title", "SocialNetworkTitle", "Description", "LanguageId", "TemplateId", "Keywords", "Content", "MetaAuthor", "MetaDescription", "MetaKeywords", "Introduction", "Volanta", "MobileTitle");
        }
    }
}
