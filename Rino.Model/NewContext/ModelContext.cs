...
using Rino.Model.Extensions.Core;
using Rino.Model.NewContext.Entities;
using Action = Rino.Model.NewContext.Entities.Action;
using TimeZone = Rino.Model.NewContext.Entities.TimeZone;

#nullable disable

namespace Rino.Model.NewContext
{
    public partial class ModelContext : IdentityDbContext<User, Role, int, UserClaim, UserRole, UserLogin, IdentityRoleClaim<int>, IdentityUserToken<int>>
    {
        ...
        public virtual DbSet<Rino.Model.NewContext.Entities.Action> Actions { get; set; }
        ...
        public virtual DbSet<Rino.Model.NewContext.Entities.TimeZone> TimeZones { get; set; }
